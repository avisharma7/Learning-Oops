...
Compile-time Polymorphism (Static): implemented at compile time. ex: method overloading
Runtime Polymorphism  (dynamic): implemented at run time. ex:  function overriding
